...
public class DictionaryServletContextListener implements ServletContextListener {
    ...
    private static final Logger logger = LoggerFactory.getLogger(com.ServletContextListener.DictionaryServletContextListener.class);
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        logger.info("----------线程执行开始----------");
        NongchanpinService nongchanpinService = (NongchanpinService)appContext.getBean("nongchanpinService");
        NongchanpinOrderService nongchanpinOrderService = (NongchanpinOrderService)appContext.getBean("nongchanpinOrderService");

        if (myThreadMethod == null) {
            myThreadMethod = new MyThreadMethod();
            myThreadMethod.setNongchanpinOrderService(nongchanpinOrderService);
            myThreadMethod.setNongchanpinService(nongchanpinService);
