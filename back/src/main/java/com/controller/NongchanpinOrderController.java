    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(nongchanpinOrder !=null){
            ...
            if(nongchanpin != null){
            BeanUtils.copyProperties( nongchanpin , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
...
//                            nongchanpinOrderEntity.setAddressId(Integer.valueOf(data.get(0)));   //收货地址 要改的
//                            nongchanpinOrderEntity.setNongchanpinId(Integer.valueOf(data.get(0)));   //商品 要改的
...
//                            nongchanpinOrderEntity.setJiezhiTimeEnd(sdf.parse(data.get(0)));          //拼团结束时间 要改的
    ...
    */
    ...
    public R add(@RequestBody NongchanpinOrderEntity nongchanpinOrder, HttpServletRequest request){
        logger.debug("add方法:,,Controller:{},,nongchanpinOrder:{}",this.getClass().getName(),nongchanpinOrder.toString());
            ...
            buyJifen = new BigDecimal(nongchanpinEntity.getNongchanpinPrice()).multiply(new BigDecimal(nongchanpinOrder.getBuyNumber())).doubleValue();//所获积分
            if(balance<0)
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : nongchanpins) {
           //取值
            ...
            nongchanpinOrderEntity.setAddressId(addressId);//收货地址
            nongchanpinOrderEntity.setNongchanpinId(nongchanpinId);//商品
            nongchanpinOrderEntity.setYonghuId(userId);//用户
            nongchanpinOrderEntity.setBuyNumber(buyNumber);//购买数量 ？？？？？？
            nongchanpinOrderEntity.setJiezhiTime(instance.getTime());//拼单截止时间 ？？？？？？
            ...
            if(nongchanpinOrderPaymentTypes == 1){//余额支付
                ...
                if(yonghuEntity.getNewMoney() - money <0 ){
                    ...
                    //计算所获得积分
                    Double buyJifen =0.0;
                    buyJifen = new BigDecimal(nongchanpinEntity.getNongchanpinPrice()).multiply(new BigDecimal(buyNumber)).doubleValue();
    ...
    */
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        String role = String.valueOf(request.getSession().getAttribute("role"));
            ...
            nongchanpinService.updateById(nongchanpinEntity);//更新订单中商品的信息
