        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '商品名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.nongchanpinName" placeholder="商品名称" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zhunongchanpincaigou/upload/nongchanpinMuBan.xls"
                        >批量导入商品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('nongchanpin','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="nongchanpinPrice"
                                      header-align="center"
                                      label="购买获得积分">
                        <template slot-scope="scope">
                            {{scope.row.nongchanpinPrice}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="nongchanpinPintuan"
                                      header-align="center"
                                      label="拼团限制/人">
                        <template slot-scope="scope">
                            {{scope.row.nongchanpinPintuan}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <!--<el-button v-if="isAuth('nongchanpin','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusNongchanpinKucunNumber(scope.row.id,scope.row.nongchanpinKucunNumber)">增加商品库存</el-button>-->
                            <!--<el-button v-if="isAuth('nongchanpin','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceNongchanpinKucunNumber(scope.row.id,scope.row.nongchanpinKucunNumber)">减少商品库存</el-button>-->
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                ...
                nongchanpinPrice : null,
                nongchanpinPintuan : null,
        ...
        methods: {
			...
			//数据不为空放值
				...
				//标题
				this.nongchanpinKucunNumberTitle = '增加商品库存'
			},
			//减少商品库存
			...
			//数据不为空放值
				...
				this.nongchanpinKucunNumberVisible = true;
				//标题
				this.nongchanpinKucunNumberTitle = '减少商品库存'
			},
			//提交用户操作商品库存数量
