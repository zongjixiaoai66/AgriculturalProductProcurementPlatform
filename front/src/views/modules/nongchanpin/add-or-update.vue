    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品名称" prop="nongchanpinName">
                       <el-input v-model="ruleForm.nongchanpinName"
                                 placeholder="商品名称" clearable  :readonly="ro.nongchanpinName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="商品名称" prop="nongchanpinName">
                           <el-input v-model="ruleForm.nongchanpinName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品编号" prop="nongchanpinUuidNumber">
                       <el-input v-model="ruleForm.nongchanpinUuidNumber"
                                 placeholder="商品编号" clearable  :readonly="ro.nongchanpinUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="商品编号" prop="nongchanpinUuidNumber">
                           <el-input v-model="ruleForm.nongchanpinUuidNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.nongchanpinPhoto" label="商品照片" prop="nongchanpinPhoto">
                        <file-upload
                            tip="点击上传商品照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.nongchanpinPhoto" label="商品照片" prop="nongchanpinPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="商品类型" prop="nongchanpinTypes">
                        <el-select v-model="ruleForm.nongchanpinTypes" :disabled="ro.nongchanpinTypes" placeholder="请选择商品类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品类型" prop="nongchanpinValue">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品库存" prop="nongchanpinKucunNumber">
                       <el-input v-model="ruleForm.nongchanpinKucunNumber"
                                 placeholder="商品库存" clearable  :readonly="ro.nongchanpinKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="商品库存" prop="nongchanpinKucunNumber">
                           <el-input v-model="ruleForm.nongchanpinKucunNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="nongchanpinOldMoney">
                       <el-input v-model="ruleForm.nongchanpinOldMoney"
                                 placeholder="商品原价" clearable  :readonly="ro.nongchanpinOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="商品原价" prop="nongchanpinOldMoney">
                           <el-input v-model="ruleForm.nongchanpinOldMoney"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="购买获得积分" prop="nongchanpinPrice">
                       <el-input v-model="ruleForm.nongchanpinPrice"
                                 placeholder="购买获得积分" clearable  :readonly="ro.nongchanpinPrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="购买获得积分" prop="nongchanpinPrice">
                           <el-input v-model="ruleForm.nongchanpinPrice"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="拼团限制/人" prop="nongchanpinPintuan">
                       <el-input v-model="ruleForm.nongchanpinPintuan"
                                 placeholder="拼团限制/人" clearable  :readonly="ro.nongchanpinPintuan"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="拼团限制/人" prop="nongchanpinPintuan">
                           <el-input v-model="ruleForm.nongchanpinPintuan"
                                     placeholder="拼团限制/人" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="商品介绍" prop="nongchanpinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.nongchanpinContent" label="商品介绍" prop="nongchanpinContent">
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    nongchanpinPrice: false,
                    nongchanpinPintuan: false,
                ...
                rules: {
                   ...
                   nongchanpinPintuan: [
                              { required: true, message: '拼团限制/人不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
