        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='nongchanpin'">
                    <el-form-item class="select" v-if="type!='info'"  label="商品" prop="nongchanpinId">
                        <el-select v-model="ruleForm.nongchanpinId" :disabled="ro.nongchanpinId" filterable placeholder="请选择商品" @change="nongchanpinChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品类型" prop="nongchanpinValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="购买获得积分" prop="nongchanpinPrice">
                        <el-input v-model="nongchanpinForm.nongchanpinPrice"
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="拼团限制/人" prop="nongchanpinPintuan">
                        <el-input v-model="nongchanpinForm.nongchanpinPintuan"
                                  placeholder="拼团限制/人" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品热度" prop="nongchanpinClicknum">
                        <el-input v-model="nongchanpinForm.nongchanpinClicknum"
                                  placeholder="商品热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品热度" prop="nongchanpinClicknum">
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="赞" prop="zanNumber">
                        <el-input v-model="nongchanpinForm.zanNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="踩" prop="caiNumber">
                        <el-input v-model="nongchanpinForm.caiNumber"
